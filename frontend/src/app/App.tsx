...
function AppRoutes() {
  ...
  const AdminRoute: React.FC<{ children: React.ReactNode }> = ({
    ...
    if (!isAuthenticated) return <Navigate to="/login" replace />;
    if (!hasAnyPermission(currentUser, ADMIN_ACCESS_PERMISSIONS))
      ...
      <Routes>
        ...
        >
          ...
          <Route
            path="learners"
            element={
              <PermissionRoute permission="users_app.view_user">
                <LearnersPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            ...
            element={
              <PermissionRoute permission="courses_app.change_course">
                <CourseBuilderPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            path="assessments"
            element={
              <PermissionRoute permission="assessments_app.view_assessment">
                <AssessmentsPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            path="analytics"
            element={
              <PermissionRoute permission="users_app.view_analytics">
                <AnalyticsPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            path="settings"
            element={
              <PermissionRoute permission="users_app.change_platform_settings">
                <AdminSettingsPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            path="rbac"
            element={
              <PermissionRoute permission="users_app.modify_permission">
                <RBACDashboardPage />
              </PermissionRoute>
            }
          />
          ...
          <Route
            path="rbac/roles"
            element={
              <PermissionRoute permission="auth.view_group">
                <RoleManagementPage />
              </PermissionRoute>
            }
          />
          <Route
            ...
            element={
              <PermissionRoute permission="auth.view_permission">
          ...
          <Route
            ...
            element={
              <PermissionRoute permission="enrollments_app.view_enrollment">
...
export default function App() {
  const googleClientId =
    ...
    "979040117820-9qgcmv76nbqpa250ioal8qf3mj54un9t.apps.googleusercontent.com";

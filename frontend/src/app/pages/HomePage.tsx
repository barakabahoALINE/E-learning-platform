...
export const HomePage: React.FC = () => {
  ...
  const getCategoryIconAndColor = (name: string) => {
    ...
    const indexToMap =
      Array.from(name).reduce((acc, char) => acc + char.charCodeAt(0), 0) % 6;
    const fallbacks = [
  ...
  const stats = [
    {
      value: publicStats.total_students
        ? `${publicStats.total_students.toLocaleString()}+`
        : "100K+",
      label: "Active Students",
    },
    {
      value: publicStats.total_instructors
        ? `${publicStats.total_instructors.toLocaleString()}+`
        : "500+",
      label: "Expert Instructors",
    },
    {
      value: publicStats.total_courses
        ? `${publicStats.total_courses.toLocaleString()}+`
        : "1,000+",
  ...
  const testimonials = [
    {
      ...
      comment:
        "LearnHub transformed my career. The courses are practical and easy to follow.",
      rating: 5,
    },
    {
      name: "Sarah Martinez",
      role: "Data Analyst",
      avatar:
        "https://images.unsplash.com/photo-1573497161161-c3e73707e25c?w=400",
      comment:
        "The instructors are amazing and the community support is incredible!",
      rating: 5,
    },
    {
      name: "James Wilson",
      ...
      comment:
        "Best investment in my education. Highly recommend to anyone looking to upskill.",
      rating: 5,
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <nav className="fixed top-4 left-0 right-0 z-50 px-4 sm:px-6 lg:px-8">
        <div
          className={`max-w-7xl mx-auto ${scrolled ? "bg-white/60 backdrop-blur" : "bg-white"} shadow-lg rounded-full px-6 py-2 flex items-center justify-between transition-all duration-300`}
        >
          ...
          <div className="hidden md:flex items-end space-x-8 pt-1">
            <a
              href="#courses"
              className="font-semibold hover:text-[#2D51A1] transition-colors"
            >
              Courses
            </a>
            <a
      ...
      <section className="relative overflow-hidden min-h-[600px] lg:h-screen flex items-center w-full pt-20 lg:pt-0">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 w-full relative z-20 h-full">
          <div className="grid grid-cols-1 lg:grid-cols-2 h-full items-center">
            ...
            <div className="flex flex-col justify-end items-end pb-12 px-0 sm:px-6 lg:px-0 text-white h-full min-h-[500px]">
              {/* Content Container */}
              <div className="lg:pr-10 mt-auto mb-6 max-w-md ml-auto mr-0 text-left flex flex-col items-start">
                ...
                <p className="text-lg text-blue-100/90 leading-relaxed mb-8 max-w-md">
                  ...
                  pace, earn certificates, and advance your career.
                </p>
                <div className="flex flex-wrap gap-4">
                  <Link to="/signup">
                    <Button
                      size="lg"
                      className="bg-white text-black font-bold hover:bg-blue-50 px-8 py-3 text-base transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg active:scale-95"
                    >
                      Start Learning
                    </Button>
                  </Link>
                  <Link to="/courses">
                    <Button
                      size="lg"
                      className="bg-white text-black hover:bg-blue-50 font-bold px-8 py-3 text-base transition-all duration-300 hover:scale-105 shadow-md hover:shadow-lg active:scale-95"
                    >
                      Explore courses
                    </Button>
                  </Link>
              ...
              <div className="mt-12 lg:mt-0 flex items-center justify-between w-full pt-6 relative">
                ...
                <div className="hidden lg:flex justify-center absolute left-[-60px] bottom-[-15px] z-30">
                  <a
                    href="#courses"
                    className="w-8 h-8 rounded-full border-2 border-white/80 flex items-center justify-center text-white hover:bg-white/20 transition-all duration-300 animate-bounce"
                  >
                    <svg
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
            {popularCategories.map((category) => {
              const { icon: Icon, color } = getCategoryIconAndColor(
                category.name,
              );
              const count = courses.filter(
                (c) => Number(c.category_id) === category.id,
              ).length;
              const colorMap: any = {
                ...
                <Link to="/courses" key={category.id}>
                  <Card className="hover:shadow-lg transition-all cursor-pointer group">
                    <CardContent className="p-6 text-center">
                      <div
                        className={`w-14 h-14 rounded-lg ${colorMap[color] || colorMap.blue} flex items-center justify-center mx-auto mb-3 transition-all group-hover:scale-110`}
                      >
      ...
      <section id="features" className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We provide comprehensive learning tools and support to help you
              achieve your goals
            </p>
          </div>
              ...
              return (
                ...
                >
                  <CardContent className="p-6">
                    <div
                      className={`w-12 h-12 rounded-lg ${colorMap[feature.color]} flex items-center justify-center mb-4`}
                    >
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <div className="bg-gradient-to-br from-[#33A7DF] to-[#2D51A1] rounded-3xl p-12 text-white">
            ...
            <p className="text-xl opacity-90 mb-8 max-w-2xl mx-auto">
              Join over 100,000 students already learning on LearnHub. Start
              your journey today!
            </p>
